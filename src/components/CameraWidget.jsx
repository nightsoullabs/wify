...
export const CameraWidget = ({ showClapDetection = true }) => {
  ...
  return (
    <>
      <button
        ...
        } transition-colors duration-200 flex items-center justify-center z-20 p-3 rounded-full text-white drop-shadow-sm`}
      >
        {!start ? (
          <svg
      ...
      {/* Removed clap detection button as it's now always enabled */}
      
      <div
        className={`absolute z-[999999] bottom-24 right-4 w-[240px] h-[180px] md:w-[320px] md:h-[240px] rounded-[20px] overflow-hidden ${
          !start ? "hidden" : ""
        }`}
        width={640}
        height={480}
